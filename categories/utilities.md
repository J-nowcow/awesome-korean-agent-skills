...
| prime-agent |  | 코딩 및 자율 작업용 RLM 에이전트 | 영+한 | [prime-agent](https://github.com/PrimeIntellect-ai/prime-agent) |
| Fuxi |  | 터미널 기반 AI 코딩 에이전트 | 영+한 | [Fuxi](https://github.com/fuxicodex/Fuxi) |
## 🪝 Hooks
