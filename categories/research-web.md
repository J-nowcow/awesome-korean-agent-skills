...
| 이름 | 도구 | 설명 | 언어 | 레포 |
|------|------|------|------|------|
| browser-pilot | CC | CDP 브라우저 자동화·스크래핑·폼 작성 | 영+한 | [claude-code-marketplace](https://github.com/Dev-GOM/claude-code-marketplace/tree/main/plugins/browser-pilot/skills) |
| external-context | CC | 쿼리 분해→병렬 에이전트 외부 문서 수집 | 영+한 | [oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode/tree/main/skills/external-context) |
