...
| 이름 | 도구 | 설명 | 언어 | 레포 |
|------|------|------|------|------|
| claude-mem | CC/GC | 세션 간 지속적인 에이전트 메모리 압축 | 다국어(KO) | [claude-mem](https://github.com/thedotmack/claude-mem) |

| awesome-claude-skills | CC/GC | Claude AI 워크플로우를 위한 스킬 모음 | 영+한 | [awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) |
...
| pm-claude-skills | CC | 다양한 직업군을 위한 Claude 스킬 모음 | 영+한 | [pm-claude-skills](https://github.com/mohitagw15856/pm-claude-skills) |
...
| 이름 | 도구 | 설명 | 언어 | 레포 |
|------|------|------|------|------|
| learn-claude-code | CC | Claude Code 에이전트 구축 프레임워크 | 다국어(KO) | [learn-claude-code](https://github.com/shareAI-lab/learn-claude-code) |
...
| NGV20260917 | CC | AI 개발 방법론 및 스킬 컬렉션 | 한국어 | [NGV20260917](https://github.com/DongJoonHan/NGV20260917) |
