...
| [Project Initialization](categories/project-init.md) | Framework scaffolding, spec & plan setup | 22+ |
...
| [Git & Workflow](categories/git-workflow.md) | Commits, PRs, worktrees, branching strategies | 19+ |
| [Refactoring & Code Cleanup](categories/refactoring.md) | Dead code removal, tech debt, simplification | 7+ |
| [Multi-Agent Orchestration](categories/multi-agent.md) | Parallel & sequential agent coordination automation | 36+ |
| [AI & Prompt Engineering](categories/ai-prompt.md) | Prompt optimization, cross-model collaboration, self-learning | 9+ |
| [Web Frontend](categories/web-frontend.md) | React, Next.js, Tailwind, UI/UX | 22+ |
...
| [Research & Web](categories/research-web.md) | Web search, scraping, Markdown conversion | 16+ |
